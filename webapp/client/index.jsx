    ...
    <Router>
      <div style={{ display: 'flex', minHeight: '100vh' }}>
        <nav style={{ width: 220, background: '#222b3a', color: '#fff', padding: '2rem 1rem 1rem 1rem', display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Link to="/data-entry" style={{ color: '#fff', textDecoration: 'none', fontWeight: 500 }}>Data Entry</Link>
        </nav>
...
function Landing() {
  return (
    <div style={{ maxWidth: 600, margin: '3rem auto', textAlign: 'center' }}>
      <h1>Welcome to the CDISC Biomedical Concepts Web App</h1>
      <p style={{ fontSize: 18, margin: '2rem 0' }}>
        Use the navigation bar on the left to access the Data Entry page.
      </p>
      <Link to="/data-entry" style={{ padding: '12px 32px', background: '#1976d2', color: '#fff', borderRadius: 6, fontWeight: 600, textDecoration: 'none', fontSize: 18 }}>Go to Data Entry</Link>
    </div>
  );
}
